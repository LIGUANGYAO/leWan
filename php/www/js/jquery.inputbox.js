 ...
 *	<div name="rbt" type="radiobox" val="cn" class="checked"></div><span>中文</span>
...
;(function($){
	...
	var selectbox = {
		...
		init: function(o) {
			...
			$o.css({'width': _width, 'height': '30px'}).find('div.selected').css({'height': opts.height, 'line-height': opts.height +'px'});
	...
	var checkbox = {
		...
		init: function(o) {
			...
			$o.addClass('cb');
			$o.append($('<input type="checkbox" name="' + _name + '" value="' + _value + '" class="none"/>'));
	...
	var radiobox = {
		...
		init: function(o) {
			...
			$o.addClass('rb');
			$o.append($('<input type="radio" name="' + _name + '" value="' + _value + '" class="none" />'));
