...
DELIMITER ;;
CREATE DEFINER=`lewan2018`@`%` EVENT `timer_automakeuserdata` ON SCHEDULE EVERY 4 HOUR STARTS '2018-12-25 09:32:49' ON COMPLETION PRESERVE ENABLE DO
  out_label: begin
