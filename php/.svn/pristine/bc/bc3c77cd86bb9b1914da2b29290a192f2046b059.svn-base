...
class FinanceController extends AdminBaseController
{
    ...
    public function exportOrder(){
        ...
        $column = ['订单id', '订单编号', '第三方交易流水号', '客户姓名', '客户电话', '订单总金额', '到店/快递', '现金抵扣金额', '优惠券抵扣金额', '实际付款金额', '商家名称', '支付方式', '下单时间', '付款时间', '商品id', '商品名称', '型号', '数量', '单价', '成本', '订单商品总金额', '订单商品成本','新人免单佣金', '一级佣金', '上级佣金', '运营佣金', '运营奖金', '玩主奖金', '直属玩主奖', '退款状态', '退款时间'];
    ...
    public function exporttable(){
        ...
        $column = ['代收总额', '代收总额', '优惠券总面额', '结算总额', '推广产品销售数量', '预约加价总额', '佣金总额', '退款总额', '退款扣除会员佣金', '退款扣除会员现金', '已结算佣金总额', '提现总额', '手续费总额', '商家结算总金额', '交易用户量', '日期'];
        $em = new ExcelModel();
