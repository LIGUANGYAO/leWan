...
IFNULL(rf.refund_num,0) refund_num, IFNULL(rf.refund_num,0)*p.settle as refund_totalsettle, (case rf.refund_type when 1 then p.commission when 2 then p.commission else 0 end) as `refund_commission`,
