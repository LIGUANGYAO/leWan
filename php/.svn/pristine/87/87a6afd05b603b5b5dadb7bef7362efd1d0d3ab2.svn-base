...
class OpenTmModel
{
     ...
     * @param $order
     */
    public function sendTplmsg1($user,  $data){
        $obj['touser'] = $user['openid'];
        ...
        $res = wx_post('https://api.weixin.qq.com/cgi-bin/message/template/send?access_token='.$user['accesstoken'], json_encode($obj));
    }
     ...
     * @param $order
     */
    public function sendTplmsg2($user,  $data){
        $obj['touser'] = $user['openid'];
     ...
     * @param $order
     */
    public function sendTplmsg3($user, $data){
        $obj['touser'] = $user['openid'];
     ...
     * @param $order
     */
    public function sendTplmsg5($user, $data){
        $obj['touser'] = $user['openid'];
