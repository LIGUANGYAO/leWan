...
class WxtokenController extends Controller {
    ...
    public function test() {
        //get post data, May be due to the different environments
        $postStr = "<xml>
				<ToUserName><![CDATA[omQ9huL2qbiLhnTz6BGXncI0xYPc]]></ToUserName>
				<FromUserName><![CDATA[omQ9huL2qbiLhnTz6BGXncI0xYPc]]></FromUserName>
				<CreateTime>123456789</CreateTime>
				<MsgType><![CDATA[text]]></MsgType>
				<Content><![CDATA[内测]]></Content>
				<Event><![CDATA[CLICK]]></Event>
                                <EventKey><![CDATA[e8dd1a462ab4bfb430bbe528f7767cb1]]></EventKey>
				</xml>";
        //extract post data
        if (!empty($postStr)) {
            /* libxml_disable_entity_loader is to prevent XML eXternal Entity Injection,
