	...
	$.ajax({
		...
		success: function(data) {
			if(data.code == 200) {
				...
				wx.ready(function(){
					wx.hideMenuItems({ menuList: ['menuItem:share:QZone','menuItem:share:qq',"menuItem:openWithQQBrowser","menuItem:openWithSafari",
												"menuItem:share:weiboApp","menuItem:share:email","menuItem:readMode","menuItem:favorite","menuItem:originPage"
										]
					});
				});
			}
