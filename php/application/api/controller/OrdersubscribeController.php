...
class OrdersubscribeController extends ApiBaseController{
    ...
    public function OrderType(){
        try{
            ...
            $Field = "o.order_id,o.order_no,o.order_isexpress as express,order_reservation as reservation,o.order_fullname as fullname,o.order_mobile as mobile,o.order_leave as remarks,m.merchant_name as shopname,p.product_name,p.price,p.settle,p.num,p.product_startusetime as startusetime,p.product_endusetime as endusetime";
