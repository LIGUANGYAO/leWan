...
class AccountRecordModel {
     ...
     * @return bool
     */
    public function add($user_id, $record_currency, $record_action, $record_amount, $record_attach, $record_remark) {
        if($record_amount == 0){
            return true;
        }
     ...
     * 生成附件信息
     */
    public function getRecordAttach($fromToken, $nickname='平台', $orderId=0) {
        $data['user_id'] = $fromToken;
