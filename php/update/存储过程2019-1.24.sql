...
CREATE ALGORITHM=UNDEFINED DEFINER=`lewan2018`@`%` SQL SECURITY DEFINER VIEW `view_forjiesuanciyue` AS select `jay_account_commission201812`.`user_id` AS `user_id`,sum(`jay_account_commission201812`.`record_amount`) AS `record_amount`,'2018年12月' AS `tag` from `jay_account_commission201812` where ((`jay_account_commission201812`.`record_action` in (606,604,607)) and (`jay_account_commission201812`.`record_status` = 1)) group by `jay_account_commission201812`.`user_id` order by NULL ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`lewan2018`@`%` SQL SECURITY DEFINER VIEW `view_tempjiesuanoneandone` AS select `jay_account_commission201812`.`record_id` AS `record_id`,`jay_account_commission201812`.`user_id` AS `user_id`,`jay_account_commission201812`.`order_id` AS `order_id`,`jay_account_commission201812`.`record_currency` AS `record_currency`,`jay_account_commission201812`.`record_action` AS `record_action`,`jay_account_commission201812`.`record_amount` AS `record_amount`,`jay_account_commission201812`.`record_balance` AS `record_balance`,`jay_account_commission201812`.`record_addtime` AS `record_addtime`,`jay_account_commission201812`.`record_attach` AS `record_attach`,`jay_account_commission201812`.`record_remark` AS `record_remark`,`jay_account_commission201812`.`record_status` AS `record_status` from `jay_account_commission201812` where ((`jay_account_commission201812`.`record_status` = 1) and (`jay_account_commission201812`.`record_action` in (601,602,603))) union all select `jay_account_commission201901`.`record_id` AS `record_id`,`jay_account_commission201901`.`user_id` AS `user_id`,`jay_account_commission201901`.`order_id` AS `order_id`,`jay_account_commission201901`.`record_currency` AS `record_currency`,`jay_account_commission201901`.`record_action` AS `record_action`,`jay_account_commission201901`.`record_amount` AS `record_amount`,`jay_account_commission201901`.`record_balance` AS `record_balance`,`jay_account_commission201901`.`record_addtime` AS `record_addtime`,`jay_account_commission201901`.`record_attach` AS `record_attach`,`jay_account_commission201901`.`record_remark` AS `record_remark`,`jay_account_commission201901`.`record_status` AS `record_status` from `jay_account_commission201901` where ((`jay_account_commission201901`.`record_status` = 1) and (`jay_account_commission201901`.`record_action` in (601,602,603))) ;
  ...
  out_label: BEGIN
    ...
    repeat
      ...
      IF NOT done THEN
        ...
        SET @v_sql = CONCAT(@v_sql, ' AND record_action in (604,606,607)');
